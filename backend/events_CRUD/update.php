                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label></label> <input type="text" name="EventName" class="form-control <?php echo (!empty($EventName_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $EventName; ?>"> <span class="invalid-feedback"><?php echo $EventName_err; ?></span>
                        </div>

                        <div class="form-group">
                            <label>EventDescription</label>
                            <textarea name="EventDescription" class="form-control <?php echo (!empty($Description_err)) ? 'is-invalid' : ''; ?>"><?php echo $EventDescription ?></textarea>
